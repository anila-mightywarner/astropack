...
<div class="blogs-form form-inline">
    ...
    <div class="row">
        <div class='col-md-4 col-sm-4 col-xs-12 left_padd'>
            <?= $form->field($model, 'image', ['options' => ['class' => 'form-group'], 'template' => '{label}<label>Image [ File Size :( 730x660 ) ]</label>{input}{error}'])->fileInput(['maxlength' => true])->label(FALSE) ?>
            <?php
...
<script>
    var editor = CodeMirror.fromTextArea(document.getElementById("blogs-other_meta_tags"), {
        lineNumbers: true,
        mode: "text/html",
        matchBrackets: true
    });
