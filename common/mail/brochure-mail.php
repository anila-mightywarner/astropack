                            ...
                            <div class="replay-content" style="text-align: justify;padding-right: 50px;padding-left: 50px;">
                                <div class="main-content">
                                    <table style="border-collapse: collapse;width: 100%;text-align: left;margin-bottom: 30px;border: 1px solid #c7c4c4;">
                                        ...
                                        <tr>
                                            <th style="border: 1px solid #c7c4c4;text-align: left;padding: 5px 10px;">Product</th>
                                            <?php
                                            $product_name = '';
                                            if (!empty($model->product_id)) {
                                                $product = \common\models\Products::find()->where(['id' => $model->product_id])->one();
                                                if (!empty($product)) {
                                                    $product_name = $product->product_title;
                                                }
                                            }
                                            ?>
                                            <td style="border: 1px solid #c7c4c4;text-align: left;padding: 5px 10px;"><?= $product_name ?></td>
                                        </tr>
                                        <tr>
